...
class TabletExperienceCard extends StatefulWidget {
...
class _TabletExperienceCardState extends State<TabletExperienceCard> {
  bool isHover = false;
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: SizedBox(
                  width:
                      391 + (widget.width - 0.3) * (698 - 391) / (0.75 - 0.3),
                  child: Text(
                    widget.description,
